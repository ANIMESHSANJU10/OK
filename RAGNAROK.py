...
bot = telebot.TeleBot('7281419606:AAE0pnk8brUu3jzXw4e3l0qWrYBYLHFBUKY')
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, \n✨✨Premium \nAttack1 STARTED 🚀 BY SANJU.\n\n📡 𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n🔌 𝐏𝐨𝐫𝐭: {port}\n⏱️ 𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n\n𝐌𝐞𝐭𝐡𝐨𝐝: Premium \nBy https://t.me/Sanjai10_oct_2k03"
    bot.reply_to(message, response)
